  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontSize: '13px', color: 'var(--text-muted)', margin: 0 }}>
            Complete registry and real-time status of all gas sensors
          </p>
        </div>
      ...
      <div style={{
        ...
        <input
          type="text"
          placeholder="Filter sensors by Model or location..."
          value={searchTerm}
      ...
      {viewMode === 'grid' ? (
        <div style={{
          ...
          {filtered.map(s => (
            <ScrubberCard key={s.sensor_id} scrubber={s} onClick={onSelectScrubber} />
          ))}
        </div>
      ) : (
        <div style={{
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '13px' }}>
            <thead>
              <tr style={{
                ...
                <th style={{ padding: '14px 18px' }}>Gas Type</th>
            ...
            <tbody>
              {filtered.map(s => {
                ...
                return (
                  <tr
                    key={s.sensor_id}
                    onClick={() => onSelectScrubber(s.sensor_id)}
                    style={{
                      borderBottom: '1px solid var(--border-subtle)',
                      cursor: 'pointer',
