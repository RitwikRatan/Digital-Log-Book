...
export default function AlertsView({ alerts, onToggleAlertStatus, onSelectScrubber }) {
  ...
  const filteredAlerts = useMemo(() => {
    return alerts.filter((alt) => {
      const matchSearch =
        (alt.sensorId || alt.scrubberId || '').toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={{
        ...
        <div>
          <h1 style={{
            ...
            <span>Gas Telemetry Safety & Alarm Log</span>
          </h1>
          <p style={{ fontSize: '13px', color: 'var(--text-muted)', margin: 0 }}>
            Automated anomaly detection alerts based on plant gas safety thresholds
          </p>
        </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <input
            type="text"
            placeholder="Search alerts by Sensor ID, Cause, or Action..."
            value={searchTerm}
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '13px' }}>
              <thead>
                <tr style={{
                  ...
                  <th style={{ padding: '14px 16px' }}>Sensor ID</th>
                  <th style={{ padding: '14px 16px' }}>Current Value</th>
                  ...
                  return (
                    ...
                    >
                      ...
                      <td style={{ padding: '14px 16px' }}>
                        <button
                          onClick={() => onSelectScrubber(alt.sensorId || alt.scrubberId)}
                          className="btn-interactive"
                          style={{
                            background: 'rgba(21, 101, 192, 0.12)',
                            border: '1px solid rgba(21, 101, 192, 0.3)',
